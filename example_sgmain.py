...
class HttpUtil(
    ...
    @java_method_def(
        name="sendSyncHttpGetRequestBridge",
...
class SPUtility2(
    ...
    @staticmethod
    @java_method_def(
        name="saveToFileUnifiedForNative",
    ...
    def readSS(mu, ctx, s1):
        if s1 in SPUtility2._kv:
            return SPUtility2._kv[s1]
        return String("")
...
class DataReportJniBridge(
    ...
    @staticmethod
    @java_method_def(
        name="registerAccsListnerBridge", signature="()I", native=False
    )
...
class CallbackHelper(
    metaclass=JavaClassDef, jvm_name="com/taobao/dp/util/CallbackHelper"
):
    def __init__(self):
        pass
...
class UserTrackMethodJniBridge(
    ...
    @staticmethod
    @java_method_def(
        name="getStackTrace", signature="(II)Ljava/lang/String;", native=False
    )
