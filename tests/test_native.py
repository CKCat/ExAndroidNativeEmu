...
class TestNative(unittest.TestCase):
    def test_something(self):
        ...
        res = emulator.call_symbol(
            module,
            "Java_com_aeonlucid_nativetesting_MainActivity_testOneArg",
    ...
    def __test_tls_common(self, emulator, libcm):
        ...
        key = memory_helpers.read_ptr_sz(
            emulator.mu, key_buf_ptr, emulator.get_ptr_size()
        )
        target_int = 3000
    ...
    def test_64_elf(self):
        ...
        try:
            ...
            emulator.call_symbol(
                libtest, "JNI_OnLoad", emulator.java_vm.address_ptr, 0x00
            )
            t = TestClass()
