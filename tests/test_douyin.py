...
from unicorn import UC_HOOK_MEM_READ, UC_HOOK_MEM_WRITE, UC_PROT_EXEC, UcError
...
class java_lang_Thread(metaclass=JavaClassDef, jvm_name="java/lang/Thread"):
    ...
    def getStackTrace(self, *args, **kwargs):
        lst = [
            ...
            java_lang_StackTraceElement(String("java.lang.reflect.Method")),
            java_lang_StackTraceElement(
                String("com.android.internal.os.ZygoteInit$MethodAndArgsCaller")
            ),
...
class TestExampleDouyin(unittest.TestCase):
    def test_douyin(self):
        ...
        try:
            ...
            logger.info("result: %s" % "".join(["%02x" % b for b in result]))
