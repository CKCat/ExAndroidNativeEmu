...
class Helper(
    ...
    jvm_name="com/SecShell/SecShell/Helper",
    jvm_fields=[
        JavaFieldDef(
            "PKGNAME",
            "Ljava/lang/String;",
            True,
            String("com.myxh.coolshopping"),
        )
    ],
):
    def __init__(self):
...
class DexInstall(
    metaclass=JavaClassDef, jvm_name="com/SecShell/SecShell/DexInstall"
):
    def __init__(self):
        pass
    ...
    @java_method_def(
        name="install",
        args_list=["jobject", "jstring", "jstring"],
        signature="(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;)V",
        native=False,
    )
...
class DexInstallV26(
    metaclass=JavaClassDef, jvm_name="com/SecShell/SecShell/DexInstall$V26"
):
    def __init__(self):
        pass
    ...
    @java_method_def(
        ...
        signature="(Ljava/lang/ClassLoader;Ljava/lang/String;)V",
        native=False,
    )
