...
class ResponseBody(metaclass=JavaClassDef, jvm_name="okhttp3/ResponseBody"):
    ...
    @java_method_def(
        name="string", signature="()Ljava/lang/String;", native=False
    )
    def string(self, emu):
        raise NotImplementedError()
...
class Builder(metaclass=JavaClassDef, jvm_name="okhttp3/Request$Builder"):
    ...
    @java_method_def(
        name="build", signature="()Lokhttp3/Request;", native=False
    )
...
class HttpUrl(metaclass=JavaClassDef, jvm_name="okhttp3/HttpUrl"):
    ...
    @java_method_def(
        name="encodedPath", signature="()Ljava/lang/String;", native=False
    )
...
class Request(metaclass=JavaClassDef, jvm_name="okhttp3/Request"):
    ...
    @java_method_def(
        name="body", signature="()Lokhttp3/RequestBody;", native=False
    )
    def body(self, emu):
        raise NotImplementedError()

    @java_method_def(
        name="headers", signature="()Lokhttp3/Headers;", native=False
    )
...
class Response(metaclass=JavaClassDef, jvm_name="okhttp3/Response"):
    ...
    @java_method_def(
        name="body", signature="()Lokhttp3/ResponseBody;", native=False
    )
    def body(self, emu):
        raise NotImplementedError()
...
class Chain(metaclass=JavaClassDef, jvm_name="okhttp3/Interceptor$Chain"):
    ...
    @java_method_def(
        name="request", signature="()Lokhttp3/Request;", native=False
    )
