...
class AssetManagerHooks:
    ...
    def register(self):
        self._modules.add_symbol_hook(
            ...
            self.__hooker.write_function(self.__AAssetManager_fromJava),
        )
        self._modules.add_symbol_hook(
            "AAssetManager_open",
            self.__hooker.write_function(self.__AAssetManager_open),
        )
        self._modules.add_symbol_hook(
            "AAsset_close", self.__hooker.write_function(self.__AAsset_close)
        )
        self._modules.add_symbol_hook(
